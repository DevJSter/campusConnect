...
const NavBar = () => {
    ...
    return (
        <header className={`${headerClasses}`} fixed top-0 w-full bg-gradient-to-b bg-sky-15 shadow-md z-1000 style={{backgroundImage: 'linear-gradient(to bottom, rgba(0,0,0,0.0.2), rgba(0,0,0,0))',
